      ...
      <main className="mx-auto max-w-5xl py-10 px-4 sm:px-6 lg:px-8 text-gray-800">
        ...
        <section id="experiments" className="mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
            <figure className="rounded-xl border p-2 md:w-1/3">
              <img src={experimentImages.original} alt="Input sample" className="w-full object-cover rounded-lg" />
            ...
            <figure className="rounded-xl border p-2 md:w-1/3 flex flex-col items-center">
              <div className="grid grid-cols-2 gap-2 w-full">
                <img src={experimentImages.edges} alt="Input A" className="w-full object-cover rounded-lg" />
                <img
            ...
            <figure className="rounded-xl border p-2 md:w-1/3">
              <img src={experimentImages.artist} alt="Optional reference" className="w-full object-cover rounded-lg" />
              <figcaption className="mt-2 text-center text-xs">Optional reference</figcaption>
            </figure>
            <figure className="rounded-xl border p-2 md:w-1/3">
              <img src={experimentImages.output} alt="Model output" className="w-full object-cover rounded-lg" />
        ...
        <section id="applications" className="mb-12">
          ...
          <p className="mb-4 text-sm">
            Use this space to demonstrate how your representation plugs into downstream tasks (restoration, editing,
        ...
        <section id="poster" className="mb-12">
          ...
          <div className="mx-auto max-w-3xl">
            <div className="relative w-full rounded-2xl border overflow-hidden" style={{ aspectRatio: "841 / 1189" }}>
              <iframe src={links.posterPdf} title="Project poster" className="absolute inset-0 h-full w-full" />
            </div>
          </div>
        </section>
        ...
        <footer className="border-t pt-6 text-center text-sm text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} — Replace with your group name. This page is a template; update assets and
